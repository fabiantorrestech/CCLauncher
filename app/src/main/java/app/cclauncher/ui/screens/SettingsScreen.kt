...
private val landscapeSpecificFields = setOf(
    ...
    "landscapeAppDrawerStyle",
    "landscapeAutoShowKeyboard",
    "landscapeAutoOpenFilteredApp",
    "landscapeSearchResultsFontSize",
    "landscapeItemSpacing",
    "landscapeAppDrawerAlignment",
    "landscapeShowScrollbar",
    "landscapeScrollbarOnLeft",
    ...
    SettingsTab(
        ...
        sections = listOf(
            ...
            SettingsSectionSpec(
                title = "Landscape",
                entries = listOf(
                    field("landscapeAppDrawerStyle"),
                    field("landscapeAutoShowKeyboard"),
                    field("landscapeAutoOpenFilteredApp"),
                    field("landscapeSearchResultsFontSize"),
                    field("landscapeItemSpacing"),
                    field("landscapeAppDrawerAlignment"),
                    field("landscapeShowScrollbar"),
                    field("landscapeScrollbarOnLeft"),
                ),
            ),
            SettingsSectionSpec(
                title = "App Tags",
